      ...
      <div className="flex items-center space-x-6">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-56 rounded-lg border-slate-200 shadow-none p-1">
            ...
            <DropdownMenuItem className="cursor-pointer rounded-md text-sm text-slate-700 focus:bg-orange-50 focus:text-orange-600" onClick={() => router.push('/platform/settings')}>Settings</DropdownMenuItem>
